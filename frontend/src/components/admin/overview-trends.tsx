...
import type { DailyOverviewMetricDTO } from "@/types";

export function SevenDayTrends({ data }: { data: DailyOverviewMetricDTO[] }) {
				...
				{values.map((value, index) => {
					...
					return (
						<circle
							...
							fill={color}
							fillOpacity={hoveredIndex === null || isHovered ? 1 : 0.35}
